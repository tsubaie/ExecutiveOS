...
- ui: row, bands, detail edits, mention menu (filter, arrows, insert, dismissal, quick-create), derived participants, tag overflow block, tasks panel create/attach/detach/complete, editor enter and leave, writing keys (B23), timed commit and own round trip (B24), checklist toggle (B25), template select and locale fallback (B27), expanded view (B28), note types editor.
