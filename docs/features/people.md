...
- PEOPLE-B03 **Detail**: header, contact, notes, tabs Context (full `LinkedSection`), Tasks (`tasks?linkedTo=person`), Meetings (attendee edges, upcoming first).
...
- ui: avatar initials en/ar, duplicate confirmation, tabs.
