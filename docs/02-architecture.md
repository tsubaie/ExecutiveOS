...
│   │   ├── search/                normalization, provider fan-out and merge (ADR 0021)
│   │   ├── notifications/         emit.ts: the write side, free of the registry (ADR 0022)
